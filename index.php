...
<head>
    ...
    <link rel="stylesheet" href="./css/cms.css?v201106">
    <script src="http://play-block.com//js/jquery-3.3.1.min.js"></script>
    <script src="./js/cms.js"></script>
    <title>Document</title>
</head>
<body>
    <div id="head">
        <h1 class="site_name">KIP Shop</h1>
    </div>
    <div id="cont_main">
        <div class="main_vis">
                ...
                <li>
                    <a href="#">
                        ...
                        <div class="product_cont">
                            ...
                            <div class="pro_price">1,020,000<span class="krwon_txt">원</span></div>
                            <div class="pro_intro">반응형 쇼핑몰 전용 소스코드 <br/>메인화면, 상품배열 화면, 로그인화면, 결제화면, 구매평, 문의, 마이페이지, 관리자페이지</div>
                        </div>
                    </a>
                </li>
